...
export default class DayTimeTabPanel extends React.Component {
	...
	renderDay = (day, index) => {
		return (
			<Day key={day.name}
				day={day}
				onClick={this.onDayClick} selected={this.state.selectedWeekdays && this.state.selectedWeekdays.includes(day.name)}
			/>
		);
	}
