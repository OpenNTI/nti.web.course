...
const t = scoped('course.info.inline.components.redemptioncodes.Disclaimer', {
	...
	description:
		'Redemption codes are a great way to grant access to your course, but there are no limitations to how many learners can use them.',
});

export default function RedemptionCodeDisclaimer() {
	return (
		<>
			<div className={cx('redemption-codes-visibility-label')}>
				{t('visibility')}
			</div>
