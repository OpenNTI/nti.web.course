...
const t = scoped('course.info.inline.enrollment.common.OptionDescription', {
	...
	openDescription: 'Get complete access to interact with all course content including the lectures, course materials, quizzes, and discussions once class is in session.',
	...
	storeDescription: 'With purchase, get complete access to interact with all course content including the lectures, course materials, quizzes, and discussions once class is in session.',
...
export const MIME_TYPES = {
	CUSTOM_EXTERNAL: 'application/vnd.nextthought.courseware.ensyncimisexternalenrollmentoption',
	...
	FIVE_MINUTE: 'application/vnd.nextthought.courseware.fiveminuteenrollmentoption'
};
...
export default class OptionText extends React.Component {
	...
	render () {
		...
		return <div className={type || TITLE}>{OptionText.getContentFor(option, type)}</div>;
	}
}
