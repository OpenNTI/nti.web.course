...
export default class CourseMenu extends React.Component {
	...
	renderEdit() {
		...
		if (doEdit) {
			return (
				<div onClick={doEdit} className="option">
					{t('edit')}
				</div>
			);
		}
	...
	renderExport() {
		...
		if (doExport) {
			return (
				<div onClick={doExport} className="option">
					{t('export')}
				</div>
			);
		}
	...
	renderDrop() {
		...
		if (doDrop) {
			return (
				<div onClick={doDrop} className="option delete-course">
	...
	renderDelete() {
		...
		if (doDelete) {
			return (
				<div onClick={doDelete} className="option delete-course">
	...
	renderSupportLink() {
		...
		if (doRequestSupport) {
			return (
				<div onClick={doRequestSupport} className="option">
					Contact Support
				</div>
			);
		}
