...
export default class OverviewDiscussionResolver extends Resolver {
	async resolve (item, overview, course) {
		const cachedValue = this.getCachedItem([course, overview, item]);
