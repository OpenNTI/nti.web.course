...
const t = scoped('course.progress.widgets.PassFailMessage', {
	...
	failMessage:
		"You haven't met the requirements to complete this course yet.",
...
export default class PassFailMessage extends React.Component {
	...
	renderFailInfo() {
		return (
			<div className="fail-message">
				...
				<div className="details-link" onClick={this.viewDetails}>
					{t('failDetails')}
				</div>
			</div>
		);
	...
	render() {
		...
		return (
			<div
				className={cx('pass-fail-message', {
