...
describe('encodes and decodes links', () => {
	test('url-encodes the encoded string', () => {
		...
		const link =
			'/dataserver2/++etc++hostsites/alpha.nextthought.com/++etc++site/Courses/DefaultAPICreated/COMPLETABLE-COURSE-ID/CourseEnrollmentRoster?batchSize=1&batchStart=0&sortOn=realname&sortOrder=ascending';
